#ifndef SceneChangerShowSceneAction_h__
#define SceneChangerShowSceneAction_h__
#include "MathStuff.h"
#include "Action.h"
#include "Transform.h"
...
class Animation;
class Document;
class SceneChangerShowSceneAction : public Action
{
public:
	enum ChangeMode
	{
...
public:
	virtual boost::uuids::uuid type() const
	{
		...
		return gen("2011D0FD-2000-5222-9021-1945E6ABE107");
	}
	...
	SceneChangerShowSceneAction();
	~SceneChangerShowSceneAction();
	//default copy constructor / operator =
	virtual Action * clone() const {return new SceneChangerShowSceneAction(*this);}	
	...
	*/
	...
	virtual const char * xmlTag() const {return "SceneChangerShowScene";}
...
#endif // SceneChangerShowSceneAction_h__