...
static const char qt_meta_stringdata_PreferencesDlg[] = {
    "PreferencesDlg\0\0onOk()\0"
};
...
const QMetaObjectExtraData PreferencesDlg::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject PreferencesDlg::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_PreferencesDlg,
      qt_meta_data_PreferencesDlg, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &PreferencesDlg::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PreferencesDlg))
